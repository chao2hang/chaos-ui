...
| 维度 | 当前 | 目标 | 缺口 |
|------|------|------|------|
| ui 基础组件 | 67 | 90 | 缺 23(含 region-layout / subform-tabs / config-provider / flex / typography / spinner) |
...
> **2026-06-28 文档结构变更**: `src/intro/` 从单层扁平 MDX 改为 `zh/` + `en/` 双语子目录。旧 8 份英文 MDX 已删除;侧边栏拆为 `中文/` 与 `English/` 两个分组。§5.3 与 §8 相关条目已同步更新。
