 ...
 * @category ui/shell
 * @since 0.2.0
 * @description A vertically stacked set of expandable sections / 垂直堆叠的可展开面板组
 * @keywords accordion, expand, collapse, panel
 * @example
 * <Accordion>
 ...
 * @category ui/shell
 * @since 0.2.0
 * @description A single collapsible section within an Accordion / 手风琴中的单个可折叠区域
 ...
 * @category ui/shell
 * @since 0.2.0
 * @description The clickable header that toggles an AccordionItem's visibility / 手风琴项的点击标题，用于切换内容显隐
 * @keywords accordion, trigger, header, toggle
 * @example
 ...
 * @category ui/shell
 * @since 0.2.0
 * @description The expandable body of an AccordionItem with animated height / 手风琴项的可展开内容区域，带高度动画
 * @keywords accordion, content, panel, animated
 * @example
 * <AccordionContent>Expandable content here</AccordionContent>
 */
