...
interface InvoicePreviewProps extends React.ComponentProps<"div"> {
  invoice: InvoiceData
  className?: string
}
...
function InvoicePreview({ invoice, className, ...props }: InvoicePreviewProps) {
  return (
    <div
      ...
      className={cn("max-w-2xl rounded-lg border bg-white p-8 text-sm shadow-sm dark:bg-card dark:text-card-foreground", className)}
      {...props}
    >
