...
function SankeyChart({ flows = DEFAULT_SANKEY, className }: SankeyChartProps) {
  ...
  return (
    ...
    >
      {/* Fixed 320 viewBox is intentional for dual-column layout (not Area/Line
          cartesian stretch path). Wide cards scroll via overflow-x-auto; do not
          blindly apply #40 RO width without redesigning band geometry. */}
