...
const rooms: MeetingRoom[] = [
  ...
  { id: "r3", name: "Boardroom", capacity: 20, floor: "5F", equipment: ["Projector", "Video"] },
];

const bookings: ExistingBooking[] = [
  { id: "b1", roomId: "r1", date: "2026-07-02", startTime: "09:00", endTime: "10:00", bookedBy: "Alice", title: "Standup" },
  { id: "b2", roomId: "r1", date: "2026-07-02", startTime: "14:00", endTime: "15:30", bookedBy: "Bob", title: "Review" },
];

describe("MeetingRoomBooking", () => {
  it("renders with data-slot", () => {
    const { container } = render(<MeetingRoomBooking rooms={rooms} />);
    expect(container.querySelector('[data-slot="meeting-room-booking"]')).toBeTruthy();
  });
  ...
  it("applies custom className", () => {
    ...
    const el = container.querySelector('[data-slot="meeting-room-booking"]') as HTMLElement;
