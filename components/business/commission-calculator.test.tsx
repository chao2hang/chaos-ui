...
describe("CommissionCalculator", () => {
  it("renders with data-slot", () => {
    const { container } = render(
      <CommissionCalculator tiers={tiers} deals={deals} />,
    );
    expect(
      container.querySelector('[data-slot="commission-calculator"]'),
    ).toBeTruthy();
  });
  ...
  it("renders tier badges", () => {
    render(
      <CommissionCalculator tiers={tiers} deals={deals} currencySymbol="¥" />,
    );
  ...
  it("renders total sales", () => {
    ...
    expect(screen.getAllByText(/¥880,000\.00/).length).toBeGreaterThan(0);
  });
  ...
  it("calculates commission with override", () => {
    ...
    expect(screen.getAllByText(/¥27,900\.00/).length).toBeGreaterThan(0);
  });
  ...
  it("applies custom className", () => {
    const { container } = render(
      <CommissionCalculator tiers={tiers} deals={deals} className="my-cc" />,
    );
