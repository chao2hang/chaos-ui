...
import { BarChart3Icon, CalendarIcon, TableIcon } from "lucide-react"
...
export const Sizes: Story = {
  render: () => (
    <div className="flex flex-col items-start gap-3">
      ...
      <SegmentedControl options={viewOptions} defaultValue="calendar" size="lg" />
    </div>
  ),
}
...
export const DisabledOption: Story = {
  args: {
    options: [
      ...
      { value: "calendar", label: "Calendar", icon: <CalendarIcon />, disabled: true },
    ],
    defaultValue: "table",
  },
}
