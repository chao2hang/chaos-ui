...
import { FullPageLoader, LoadingPage } from "@/components/business/loading-page"
    ...
    <FullPageLoader>
      <div className="p-8">
        <div className="max-w-md rounded-lg border p-6">
          ...
          <p className="mt-1 text-xs text-muted-foreground">The background content is dimmed while a full page operation completes.</p>
        </div>
      </div>
    </FullPageLoader>
  ),
