...
function ConfirmDialogDemo(args: ConfirmDialogProps) {
  ...
  return (
    <div className="flex min-h-48 flex-col items-start gap-3">
      ...
      {confirmed && (
        <p className="text-sm text-success">The confirm action has been recorded.</p>
      )}
      <ConfirmDialog
        {...args}
        open={open}
...
export const Default: Story = {
  args: {
    ...
    description: "The campaign will be hidden from active dashboards but can be restored later.",
    confirmText: "Archive",
...
export const Destructive: Story = {
  args: {
    ...
    description: "This action cannot be undone and all linked automations will lose this audience.",
...
export const Loading: Story = {
  args: {
    ...
    description: "Please wait while the campaign configuration is being published.",
