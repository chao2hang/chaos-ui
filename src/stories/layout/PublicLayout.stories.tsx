        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-semibold tracking-tight md:text-5xl">
              Coordinate orders, inventory, and dispatch from one enterprise
              workspace.
            </h1>
            <p className="text-muted-foreground text-lg">
              Give sales, warehouse, finance, and logistics teams the same
              source of truth for perishable supply chains.
            </p>
          </div>
    ...
    <PublicLayout
      ...
      footer={
        <div className="container mx-auto">
          Customer operations hotline - 400-800-2688 - support@chao2hang.com
        </div>
      }
    >
      <section className="container mx-auto space-y-6 px-4 py-12">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-semibold">
            Track every shipment from order to dock.
          </h1>
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Customers can monitor replenishment orders, cold-chain handoffs, and
            invoice readiness without calling account managers.
          </p>
        </div>
        <div className="grid gap-4 md:grid-cols-3">
          {["Live ETA", "Temperature proof", "Invoice packets"].map(
            (feature) => (
              <Card key={feature}>
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-muted-foreground text-sm">
                    Enterprise-grade visibility for procurement and store
                    operations teams.
                  </p>
                </CardContent>
              </Card>
