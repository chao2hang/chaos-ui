...
export const componentLoaders: Record<string, React.ComponentType<any>> = {
  ...
  IntegrationExceptionWorkbench: dynamic(
    () =>
      import("@chaos_team/chaos-ui/business").then((m) => ({
        default: m.IntegrationExceptionWorkbench,
      })),
    { ssr: false },
  ),
  ...
  MobileAuthLayout: dynamic(
    () =>
      import("@chaos_team/chaos-ui/mobile").then((m) => ({
