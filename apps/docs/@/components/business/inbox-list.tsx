...
export function InboxList({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-card flex h-full flex-col rounded-md border",
        className,
      )}
      {...props}
    >
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((item) => (
            <div
              ...
              className={cn(
                "hover:bg-muted/30 flex w-full cursor-pointer items-start gap-2 border-b px-3 py-2.5 text-left transition-colors",
