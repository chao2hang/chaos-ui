...
export function CalendarMonth({
  ...
  const monthLabel = current.toLocaleDateString(locale, {
    year: "numeric",
    month: "long",
  });
  ...
  return (
    <div data-slot="calendar-month" className={cn("space-y-3", className)}>
      ...
      <div className="bg-border grid grid-cols-7 gap-px rounded-md border">
        {grid.map(({ date, inMonth }, i) => {
          ...
          return (
            <button
              ...
              className={cn(
                "bg-background hover:bg-muted/30 min-h-24 p-1 text-left transition-colors",
