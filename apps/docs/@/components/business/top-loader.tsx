...
export function TopLoader({
  ...
  return (
    <div
      ...
      aria-valuemax={100}
      className={cn(
        "bg-primary/15 pointer-events-none fixed inset-x-0 top-0 z-[100] h-0.5 overflow-hidden",
    ...
    >
      {phase === "loading" && (
        <div
          ...
          className="bg-primary top-loader-indicator h-full w-1/3"
        />
      )}
      {phase === "completing" && <div className="bg-primary h-full w-full" />}
    </div>
  );
}
