        ...
        <div className="mt-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hover:bg-muted inline-flex h-8 items-center gap-1 rounded-lg px-2.5 text-sm font-medium disabled:pointer-events-none disabled:opacity-50"
            >
            ...
            {isLast ? (
              <button
                type="button"
                onClick={onClose}
                className="bg-primary text-primary-foreground hover:bg-primary/80 inline-flex h-8 items-center gap-1 rounded-lg px-2.5 text-sm font-medium"
              >
