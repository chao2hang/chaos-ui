 ...
 * @since 0.2.0
 * @description A root navigation menu built on @base-ui/react NavigationMenu with alignment control for site-wide navigation / 基于 @base-ui/react NavigationMenu 的根导航菜单，支持对齐控制，用于站点级导航
 * @keywords navigation, menu, root, base-ui, alignment
 * @example
 * <NavigationMenu align="start"><NavigationMenuList>...</NavigationMenuList></NavigationMenu>
 */
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description A list container for navigation menu items, rendering as a flex row / 导航菜单项的列表容器，以 flex 行方式渲染
 * @keywords navigation, menu, list, container
 * @example
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description An individual navigation menu item that can contain a trigger and content / 单独的导航菜单项，可包含触发器和内容
 * @keywords navigation, menu, item, base-ui
 * @example
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description A button trigger that opens a navigation menu item's content, with a chevron indicator and open-state styling / 打开导航菜单项内容的按钮触发器，带箭头指示器和展开状态样式
 * @keywords navigation, menu, trigger, button, dropdown
 * @example
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description The content panel of a navigation menu item with slide and fade transition animations / 导航菜单项的内容面板，带滑动和淡入淡出过渡动画
 * @keywords navigation, menu, content, popup, animation
 * @example
 * <NavigationMenuContent><NavigationMenuLink href="/docs">Documentation</NavigationMenuLink></NavigationMenuContent>
 */
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description Positions the navigation menu popup relative to its trigger, handling side, alignment, and offset / 将导航菜单弹出层相对于触发器定位，处理方向、对齐和偏移
 * @keywords navigation, menu, positioner, popup, portal
 * @example
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description A link element within navigation menu content with hover, focus, and active state styling / 导航菜单内容中的链接元素，具有悬停、聚焦和激活状态样式
 * @keywords navigation, menu, link, anchor
 * @example
 ...
 * @category ui/navigation
 * @since 0.2.0
 * @description A visual arrow indicator rendered below the navigation menu trigger, with animate-in/out transitions / 渲染在导航菜单触发器下方的视觉箭头指示器，具有进出动画过渡
 * @keywords navigation, menu, indicator, arrow, animation
 * @example
