...
当你需要「通知提醒」相关能力时使用：右上角弹出的通知卡片,比 Toast 内容更丰富、驻留更久。用于过程反馈与结果提示（加载、确认、警告、通知）；避免静默失败。
...
> 📘 完整交互式示例与控件属性请查看 [Storybook 文档](http://localhost:6006/?path=/docs/components-notification--docs)。
