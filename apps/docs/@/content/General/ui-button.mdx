...
Ui Button — Chaos UI 的通用基础组件。
Button — a general-purpose primitives used across the app. from Chaos UI.

## 何时使用 / When to Use

适用于Ui Button相关场景。

Use when you need a button.
...
> 📘 完整交互式示例与控件属性请查看 [Storybook 文档](?path=/docs/components-ui-button--docs)。
