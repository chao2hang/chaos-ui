...
export const VideoExample: Story = {
  render: () => (
    <div className="max-w-2xl">
      ...
      <VideoPlayer src={DEMO_VIDEO} title="Sprite Fight" />
    </div>
  ),
};
...
export const VideoWithCaptions: Story = {
  render: () => (
    <div className="max-w-2xl space-y-3">
      ...
      <VideoPlayer src={DEMO_VIDEO} title="Sprite Fight (带字幕)" />
    </div>
  ),
};
...
export const VideoAutoplayMuted: Story = {
  render: () => (
    <div className="max-w-2xl space-y-3">
      ...
      <VideoPlayer src={DEMO_VIDEO} title="Sprite Fight" autoplay />
    </div>
  ),
};
...
export const PDFExample: Story = {
  render: () => (
    <div className="h-[500px]">
      <PDFViewer src="/sample.pdf" title="产品白皮书 2026" />
    </div>
  ),
};
