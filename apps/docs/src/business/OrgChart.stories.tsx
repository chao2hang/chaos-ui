...
const sampleNodes: OrgNode[] = [
  ...
  { id: "4", name: "Dave Wilson", title: "VP Engineering", department: "Engineering" },
...
export const WithAvatars: Story = {
  args: {
    nodes: [
      { id: "1", name: "Alice Chen", title: "CEO", avatarUrl: "https://i.pravatar.cc/40?u=1", department: "Executive" },
      { id: "2", name: "Bob Smith", title: "CTO", avatarUrl: "https://i.pravatar.cc/40?u=2", department: "Engineering" },
      { id: "3", name: "Carol Lee", title: "CFO", avatarUrl: "https://i.pravatar.cc/40?u=3", department: "Finance" },
    ],
    edges: [
      { source: "1", target: "2" },
      { source: "1", target: "3" },
